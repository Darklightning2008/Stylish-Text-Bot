...
** Developer by :** ❤️ ▷ [@Speedy208](https://t.me//Speedy208)
"""

    # Buttons
    buttons = [
        [
            InlineKeyboardButton('👥 Group', url=f"https://t.me/LovelyXSupport"),
            InlineKeyboardButton('Channel 📢', url=f"https://t.me//LovelyXAssociation")
            ],[
            InlineKeyboardButton('❤️ Credit', url=f"https://t.me/{owner_username}"),
            InlineKeyboardButton('Bot Lists 🤖', url=f"https://t.me/LovelyXAssociation/5"),
            InlineKeyboardButton('GitHup 🤣', url=f"https://github.com/Darklightning2008")
            ],[
            InlineKeyboardButton('⚜️ Subscribe Now YouTube ⚜️', url=f"https://youtube.com/c/Infograph-World")
        ]
    ]
    await m.reply_text(
        text=text,
